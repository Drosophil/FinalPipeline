...
def create_or_replace_view_7a(data_load: DataLoaderToRDS):
    query = """
...
def create_or_replace_view_7b_with_Nulls(data_load: DataLoaderToRDS):
    query = """
...
def create_or_replace_view_7b_without_Nulls(data_load: DataLoaderToRDS):
    query = """
